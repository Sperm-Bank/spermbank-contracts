...
contract sSperm is ERC20Permit, Ownable {
    ...
    /**
        @notice increases sSperm supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sSperm
